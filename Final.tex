...
After this procedure, new data can be classified using the new data set. For this project, we will be using a version of the Naive Bayes classifier in addition to PCA to recognize digits.
