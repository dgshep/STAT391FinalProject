...
\begin{abstract}
This paper examines the use of Principal Components Analysis (PCA) in conjunction with a Naive Bayes Classifier applied to the problem of handwriting recognition for the numbers 0 through 9.
\end{abstract}
